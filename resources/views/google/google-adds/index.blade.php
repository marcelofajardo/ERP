        ...
        <div class="col-xs-12">
            <form class="form-search-data">
                    ...
                    <div class="col-md-3 pd-2">
                        <div class="form-group cls_task_subject border">
                            ...
                            <div class="tablesorter-header-inner">
                                <input type="checkbox" class="show-finished-task" name="google_search" id="google_search" value="true" checked>
                                <label>Google Search</label>
                            </div>
                            <div class="tablesorter-header-inner">
                                <input type="checkbox" class="show-finished-task" name="search_network" id="search_network" value="true">
                                <label>Search Network</label>
                            </div>
                            <div class="tablesorter-header-inner">
                                <input type="checkbox" class="show-finished-task" name="content_network" id="content_network" value="true">
                                <label>Content Network</label>
                            </div>
                            <div class="tablesorter-header-inner">
                                <input type="checkbox" class="show-finished-task" name="partner_search_network" id="partner_search_network" value="true">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-2 pd-2">
                        <div class="form-group">
                            <select name="filter_by_gender" id="filter_by_gender" class="form-control input-sm">
                                <option value="">Filter by Gender</option>
                                <option value="10">Male</option>
                                <option value="11">Female</option>
                                <option value="20">Undetermined</option>
                            </select>
                        </div>
                    </div>
                    <!-- Language Selection -->
                    <div class="col-xs-12 col-md-2 pd-2">
                        <div class="form-group">
                            <select name="filter_by_country" id="filter_by_country" class="form-control input-sm">
                    ...
                    <div class="col-xs-12 col-md-2 pd-2">
                        <div class="form-group">
                            <select name="filter_by_size" id="filter_by_size" class="form-control input-sm">
