...
<div class="row">
        <div class="col-lg-12 margin-tb">
            <h2 class="page-heading">SimplyDuty Currency</h2>
    ...
    <div class="table-responsive mt-3">
        <table class="table table-bordered" id="category-table">
            ...
            <tr>
            <th><input type="text" id="currency" class="search form-control"></th>    
            <th></th>
            <th></th>
          </tr>
            </thead>
            ...
            <tbody>
            @include('simplyduty.currency.partials.data')
            </tbody>
        </table>
    </div>
    {!! $currencies->appends(Request::except('page'))->links() !!}
...
<script>
 $(document).ready(function() {
        src = "{{ route('simplyduty.currency.index') }}";
        $(".search").autocomplete({
       ...
       function getCategoryData() {
           src = "{{ route('simplyduty.currency.update') }}"
           $.ajax({
                url: src,
                dataType: "json",
                data: {
