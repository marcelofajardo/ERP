<form action="{{ route('order.submit.invoice') }}" method="POST">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" name="invoice_number" class="form-control" value="{{ isset($invoice_number) ? $invoice_number : '' }}" readonly>
            </div>
            <div class="row">
              <div class="col">
                <div class="form-group">
                  ...
                  <div class='input-group date' id='invoice_date'>
                    <input type='text' class="form-control input_invoice_date" name="invoice_date" value="{{ date('Y-m-d') }}" required />
