  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form action="{{ route('agent.store') }}" method="POST">
        @csrf
        <input type="hidden" name="model_id" id="agent_vendor_id" value="{{ $old->serial_no }}">
        <input type="hidden" name="model_type" value="App\Old">

        <div class="modal-header">
          <h4 class="modal-title">Create Old Agent</h4>
