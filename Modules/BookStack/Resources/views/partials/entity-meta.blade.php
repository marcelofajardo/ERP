<div class="entity-meta">
    ...
    @else
        @icon('star')<span title="{{$entity->created_at->toDayDateTimeString()}}">{{ trans('bookstack::entities.meta_created', ['timeLength' => $entity->created_at->diffForHumans()]) }}</span>
    @endif
    ...
    @elseif (!$entity->isA('revision'))
        @icon('edit')<span title="{{ $entity->updated_at->toDayDateTimeString() }}">{{ trans('bookstack::entities.meta_updated', ['timeLength' => $entity->updated_at->diffForHumans()]) }}</span>
    @endif
</div>