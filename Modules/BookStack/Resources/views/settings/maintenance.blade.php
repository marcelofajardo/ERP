...
<div class="container small">
    ...
    <div class="grid left-focus v-center no-row-gap">
        <div class="py-m">
            @include('bookstack::settings.navbar', ['selected' => 'maintenance'])
        </div>
    ...
    <div id="image-cleanup" class="card content-wrap auto-height">
        <h2 class="list-heading">{{ trans('bookstack::settings.maint_image_cleanup') }}</h2>
                    ...
                    <div>
                        ...
                        @else
                            <label>
                                ...
                                {{ trans('bookstack::settings.maint_image_cleanup_ignore_revisions') }}
                            </label>
                        @endif
                    </div>
                    <button class="button outline">{{ trans('bookstack::settings.maint_image_cleanup_run') }}</button>
                </form>
            </div>
        </div>
    </div>
