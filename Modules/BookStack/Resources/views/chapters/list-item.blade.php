    ...
    <div class="chapter chapter-expansion">
        ...
        <div class="content">
            <button type="button" chapter-toggle
                    aria-expanded="false"
                    class="text-muted chapter-expansion-toggle">@icon('caret-right') <span>{{ trans_choice('bookstack::entities.x_pages', $chapter->pages->count()) }}</span></button>
            <div class="inset-list">
                <div class="entity-list-item-children">
                    @include('bookstack::partials.entity-list', ['entities' => $chapter->pages])
                </div>
            </div>
        </div>
    </div>
