    ...
    <div overlay ref="overlay" v-cloak @click="hide()">
        <div class="popup-body" tabindex="-1" @click.stop>
            ...
            <div class="popup-header primary-background">
                <div class="popup-title">{{ trans('bookstack::components.code_editor') }}</div>
                <button class="popup-header-close" @click="hide()">x</button>
            </div>

            <div class="p-l popup-content">
                <div class="form-group">
                    <label for="code-editor-language">{{ trans('bookstack::components.code_language') }}</label>
                ...
                <div class="form-group">
                    <label for="code-editor-content">{{ trans('bookstack::components.code_content') }}</label>
                    <textarea ref="editor" v-model="code"></textarea>
                </div>

                <div class="form-group">
                    <button type="button" class="button" @click="save()">{{ trans('bookstack::components.code_save') }}</button>
                </div>
