var page = {
    ...
    getResults: function(href) {
    	var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/dnd-list/records",
            method: "get",
    ...
    deleteRecord : function(ele) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/dnd-list/"+ele.data("id")+"/delete",
            method: "get",
            beforeSend : function() {
                $("#loading-image").show();
            }
    ...
    editRecord : function(ele) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/dnd-list/"+ele.data("id")+"/edit",
            method: "get",
        }
    ...
    submitFormSite : function(ele) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/dnd-list/save",
            method: "post",
    ...
    push : function(ele) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/dnd-list/"+ele.data("id")+"/push",
            method: "get",
            beforeSend : function() {
                $("#loading-image").show();
            }
    ...
    createDefaultStores : function(ele) {
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/dnd-list/create-default-stores",
            method: "post",
            data : {
    ...
    moveStores : function(ele) {
        ...
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/dnd-list/move-stores",
            method: "post",
            data : {
    ...
    moveDnd : function(ele) {
        ...
        var _z = {
            url: (typeof href != "undefined") ? href : this.config.baseUrl + "/dnd-list/move-dnd",
            method: "post",
            data : {
                customer_id : ids
            }
